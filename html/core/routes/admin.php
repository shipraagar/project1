  ...
  /* ------------------------------------------
   ...
   -------------------------------------------- */
    Route::controller(ThemeManageController::class)->name('landlord.')->prefix('theme')->group(function (){
        Route::get('/gallery','all_theme_gallery')->name('admin.theme.gallery');
        Route::post('/update','update_status')->name('admin.theme.status.update');
        Route::get('/index','all_theme_index')->name('admin.all.theme');
        Route::post('/all-update','all_theme_update')->name('admin.theme.update');
    });
...
|---------------------------------------------------------------------------------------------------------------------------*/
    Route::controller(\App\Http\Controllers\Tenant\Admin\NewsletterController::class)->name('landlord.')->prefix('newsletter')->group(function () {
