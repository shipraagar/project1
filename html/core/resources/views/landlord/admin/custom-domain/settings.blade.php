                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('landlord.admin.custom.domain.requests.settings')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group  mt-3">
                                ...
                                <input type="text" name="custom_domain_settings_title"class="form-control" value="{{get_static_option_central('custom_domain_settings_title')}}">
                            </div>

                            <div class="form-group">
                                <label>{{__('Description')}}</label>
                                <textarea name="custom_domain_settings_description" class="form-control" cols="30" rows="8">{{get_static_option_central('custom_domain_settings_description')}}</textarea>
                            </div>

                            <div class="form-group  mt-3">
                                <label>{{__('Table Info Data Title')}}</label>
                                <input type="text" name="custom_domain_table_title" class="form-control" value="{{get_static_option_central('custom_domain_table_title')}}">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 mt-3">
                                    ...
                                    <input type="text" readonly class="form-control" value="{{getenv('CENTRAL_DOMAIN')}}">
                                </div>
                            ...
                            <x-fields.media-upload name="custom_domain_settings_screem_show_image" title="{{__('Screen Shot Example')}}" dimentions="{{__('100*100')}}"/>
