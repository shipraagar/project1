        ...
        <table>
            ...
            @if($user_type == 'user')
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ tenant_url_with_protocol($package->tenant_id) .'.'. getenv('CENTRAL_DOMAIN') ?? ''  }}" target="_blank">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{tenant_url_with_protocol($package->tenant_id) .'.'. getenv('CENTRAL_DOMAIN')  .'/admin' ?? '' }}" target="_blank">
