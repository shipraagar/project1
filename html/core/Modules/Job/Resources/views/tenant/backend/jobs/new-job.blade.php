                ...
                <form class="forms-sample" method="post" action="{{route('tenant.admin.job.new')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <x-slug.add-markup/>
                            <x-summernote.textarea name="description" label="{{__('Job Description')}}" />
                            <x-fields.input name="experience" label="{{__('Experience')}}"/>
                            <x-fields.input name="designation" label="{{__('Designation')}}"/>
                            <x-fields.input name="job_location" label="{{__('Job Location')}}"/>
                            <x-fields.input name="company_name" label="{{__('Company Name')}}"/>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <x-fields.input type="number" name="salary_offer" label="Salary Offer"/>
                                                    <x-fields.input type="number" name="working_days" label="Working Days"/>
