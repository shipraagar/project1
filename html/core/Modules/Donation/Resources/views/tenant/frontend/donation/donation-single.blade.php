                ...
                <div class="col-lg-5">
                    ...
                    @endif
                        ...
                        <div class="prices2 mb-10">
                            <span class="price">{{ get_static_option('donation_raised_'.get_user_lang().'_text') }} {{amount_with_currency_symbol($donation->amount)}}</span>
                            <span class="dates"> {{get_static_option('donation_goal_'.get_user_lang().'_text')}} {{ amount_with_currency_symbol($donation->raised) }}</span>
                        </div>
