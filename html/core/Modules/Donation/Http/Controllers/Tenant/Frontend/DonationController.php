...
class DonationController extends Controller
{
    ...
    private const BASE_PATH = 'donation::tenant.frontend.donation.';
    ...
    public function donation_single($slug)
    {
        ...
        return view(self::BASE_PATH.'donation-single',compact('donation','comments','comments_count','all_donors_data'));
    }
...
HTML;
    ...
    public function donation_payment($id)
    {
        ...
        return view(self::BASE_PATH.'payment.payment',compact('donation'));
    ...
    public function donation_payment_success($id)
    {
        ...
        return view(self::BASE_PATH . 'payment.success')->with(['donation_logs' => $donation_logs, 'donation' => $donation]);
    }
