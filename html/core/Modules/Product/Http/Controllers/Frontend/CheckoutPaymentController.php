...
class CheckoutPaymentController extends Controller
{
    public function checkout_page()
    {
        ...
        return view('product::frontend.shop.checkout.checkout_page', compact('cart_data', 'billing_info', 'countries', 'states', 'product_tax'));
    }
    ...
    public function order_payment_success($id)
    {
        ...
        return view('product::frontend.payment.payment-success', compact('payment_details'));
