...
{
    private const BASE_PATH = 'product::frontend.shop.';
    public function shop_page(Request $request)
    {
        ...
        $grid = view("product::frontend.shop.partials.product-partials.grid-products", compact("products", "links", "current_page"))->render();
        $list = view("product::frontend.shop.partials.product-partials.list-products", compact("products", "links", "current_page"))->render();
    ...
    public function shop_search(Request $request)
    {
        ...
        return view('product::frontend.shop.product-single-search', compact('product_object', 'search'));
    }

    public function product_quick_view(Request $request)
    {
        $product = Product::with('badge', 'campaign_product')->findOrFail($request->id);
        $modal_object = view('product::frontend.shop.markup_for_controller.quick_view_product_modal', compact('product'))->render();
    ...
    public function product_details($slug)
    {
        ...
        return view('product::frontend.shop.product_details.product-details', compact(
            'product',
            'related_products',
    ...
    public function cart_page()
    {
        ...
        $wishlist = false;
        return view(self::BASE_PATH.'cart.cart_page', compact('cart_data', 'wishlist'));
    }
    ...
    public function cart_update_ajax(Request $request)
    {
        ...
        try {
            ...
            $markup = view('product::frontend.shop.cart.markup_for_controller.cart_products', compact('cart_data'))->render();
    ...
    public function cart_remove_product_ajax(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'empty_cart' => Cart::count() == 0 ? view('product::frontend.shop.cart.cart_empty')->render() : ''
        ]);
    }
    ...
    public function sync_product_total(Request $request)
    {
        ...
        $shipping_tax_markup = view('product::frontend.shop.checkout.markup_for_controller.shipping_tax_ajax', compact('product_tax', 'shipping_methods', 'default_shipping', 'country', 'state'))->render();
    ...
    public function compare_product_page(): \Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View|\Illuminate\Contracts\Foundation\Application
    {
        ...
        return view('product::frontend.shop.product-compare', compact('product_array'));
    }
    ...
    public function productQuickViewPage($slug): string
    {
        ...
        return view('product::frontend.shop.product_details.quick-view', compact(
            'product',
            'related_products',
            'available_attributes',
            'product_inventory_set',
    ...
    public function category_products($category_type = null, $slug)
    {
        ...
        return view('product::frontend.shop.single_pages.category', ['category' => $category, 'products' => $products]);
    }
    ...
    public function product_by_category_ajax(Request $request)
    {
        ...
        foreach ($products as $product) {
            ...
            $product_price = product_prices($product, 'color-two') ;
            ...
            $options = view('product::frontend.shop.partials.product-options', compact('product'))->render();
...
HTML;
    ...
    public function campaign_details($id)
    {
        ...
        return view('product::frontend.shop.campaign-details', compact('campaign', 'products'));
    }
