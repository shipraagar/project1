<ul class="cart-icon">
    ...
    @endphp
    <li class="lisItem">
        <a class="icon cart-loading product-quick-view-ajax" href="javascript:void(0)" data-id="{{$product->id}}" data-action-route="{{ route('tenant.products.single-quick-view', $product->slug) }}">
