                ...
                <form class="forms-sample" method="post" action="{{route('tenant.admin.event.new')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <x-slug.add-markup/>
                            <x-summernote.textarea label="{{__('Event Content')}}" name="description"/>
                            <x-fields.input name="organizer" label="{{__('Organizer')}}"/>
                            <x-fields.input name="organizer_email" label="{{__('Organizer Email')}}"/>
                            <x-fields.input name="organizer_phone" label="{{__('Organizer Phone')}}"/>
                            <x-fields.input name="venue_location" label="{{__('Venue Location')}}"/>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <x-fields.input type="number" name="cost" label="Ticket Cost"/>
                                                    <x-fields.input type="number" name="total_ticket" label="Total Tickets (For this event)"/>
