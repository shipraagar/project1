...
class TenantRecentServiceWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        $blog_posts = Service::where(['status' => 1])->take($blog_items)->orderBy('id','desc')->get();
        ...
        foreach ($blog_posts as $post){
            ...
            $route = route(route_prefix().'frontend.service.single',$post->slug);
