...
class TenantNewsCategoryWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        foreach ($blog_categories as $item){
            ...
            $comment_count = Blog::where('category_id',$item->id)->count();


 $category_markup.= <<<LIST
    <a href="{$url}" class="newspaper_sideWidget__category__single">
        <span class="newspaper_sideWidget__category__single__left">$title</span>
        <span class="newspaper_sideWidget__category__single__right">{$comment_count}</span>
    </a>
LIST;
...
<div class="newspaper_sideWidget__single">
    ...
    <div class="newspaper_sideWidget__inner mt-4">
        <div class="newspaper_sideWidget__category">
            {$category_markup}
        </div>
    </div>
</div>
HTML;
    ...
    {
        return __('Tenant News Category');
    }
}
