...
class WidgetBuilderSetup
{
    ...
    private static function registerd_sidebars(){
        ...
        $register_widgets_for_tenant = ['footer_donation','footer_event','footer_job','footer_knowledgebase','footer_ticket',
                                        'footer_eCommerce','footer_agency','blog_sidebar','service_sidebar',
                                         'donation_sidebar','donation_acitvities_sidebar','event_sidebar','job_sidebar',
                                         'knowledgebase_sidebar','newspaper_sidebar','newspaper_sidebar_two','newspaper_footer',
                                          'construction_footer','consultancy_footer'
                                        ];

        $condition = tenant() ? $register_widgets_for_tenant : $register_widgets_for_admin;
        return $condition;
    }
