...
class AboutTicket extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Ticket/about-ticket.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.ticket.about-ticket',$data);
    }
