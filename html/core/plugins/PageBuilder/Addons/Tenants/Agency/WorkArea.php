...
class WorkArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/Agency/work-area.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('agency_work_repeater');
        ...
        return self::renderView('tenant.agency.work-area',$data);
    }
