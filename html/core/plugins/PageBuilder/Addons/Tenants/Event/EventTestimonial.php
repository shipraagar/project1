...
class EventTestimonial extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Event/event-testimonial.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.event.event-testimonial',$data);
