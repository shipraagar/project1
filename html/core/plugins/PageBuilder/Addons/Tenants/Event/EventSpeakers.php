...
class EventSpeakers extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Event/event-speaker-01.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.event.event-speaker',$data);
