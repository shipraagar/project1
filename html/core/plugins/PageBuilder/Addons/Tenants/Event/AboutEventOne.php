...
class AboutEventOne extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Event/about-event-01.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.event.about-event-one',$data);
    }
