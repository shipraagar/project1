                        ...
                        <div class="heroCaption">
                            @php
                                   ...
                                   if (str_contains($data['title'], '{h}') && str_contains($data['title'], '{/h}'))
                                   {
                                       ...
                                       $final_title = '<h1 class="tittle" data-animation="fadeInUp" data-delay="0.1s">'.str_replace('{h}'.$highlighted_word.'{/h}', $highlighted_text, $data['title']). $shape_img.'</h2>';
                                   } else {
                                       $final_title = '<h1 class="tittle" data-animation="fadeInUp" data-delay="0.1s">'. $data['title'] .$shape_img.'</h2>';
                                   }
                            @endphp
                                {!! $final_title !!}
