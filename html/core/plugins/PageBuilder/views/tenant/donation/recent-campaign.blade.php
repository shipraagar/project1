                ...
                @foreach($data['donation'] as $item)
                    <div class="singleCases mb-40">
                        ...
                        <div class="casesCaption">
                            <h3><a href="{{route('tenant.frontend.donation.single',$item->slug)}}" class="tittle">{{ $item->getTranslation('title',$current_lang) }} </a></h3>
                            ...
                            <!-- Progress Bar -->
                            <div class="singleProgres mb-15 donation-progress" data-percentage="{{get_percentage($item->amount,$item->raised)}}">
                                <div class="bar-1"></div>
                            </div>
                            <!-- /End progress -->
                            <div class="donateMember">
                                ...
                                <div class="donateMemberList mb-10">
                                    <ul class="listing">
                                        <li class="listItem">
                                            <a href="#!"> <img src="{{global_asset('assets/tenant/frontend/themes/img/gallery/donation-donatePepols1.jpg')}}" alt="images"></a>
                                        </li>
                                        <li class="listItem">
                                            <a href="#!"> <img src="{{global_asset('assets/tenant/frontend/themes/img/gallery/donation-donatePepols2.jpg')}}" alt="images"></a>
                                        </li>
                                        <li class="listItem">
                                            <a href="#!"> <img src="{{global_asset('assets/tenant/frontend/themes/img/gallery/donation-donatePepols3.jpg')}}" alt="images"></a>
                                        </li>
                                        <li class="listItem">
                                ...
                                <div class="btn-wrapper mb-10">
                                    <a href="{{route('tenant.frontend.donation.payment',$item->id)}}" class="cmn-btn4">{{__('Donate Now')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
